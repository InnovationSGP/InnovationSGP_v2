                    ...
                    <div className="relative w-full min-h-[344px] rounded-xl overflow-hidden group">
                        ...
                        <div className="absolute inset-0 p-10 bg-[#061830CC] opacity-0 group-hover:opacity-100 transition duration-300 z-10  flex flex-col justify-between">
                            ...
                            <div className="text-white  ">
                                <h3 className="text-xl font-bold">HomeMade App and Web Development</h3>
                                  <p className="text-sm text-white max-w-md mt-8">App & Web Development</p>
                            </div>
                            ...
                            <div className="">
                                ...
                                <p className="text-sm text-white max-w-md ">
                                    HomeMade is website for culinary in
                                    ...
                                    your favourite foods and enjoy!
                                </p>
                            </div>

                            {/* Bottom Link */}
                            <div className="">
                                <Link href="#" className="text-white underline hover:text-white">Read More →</Link>
                            </div>
                        </div>
                    </div>
