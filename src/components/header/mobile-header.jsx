...
//     return (
//         <>
//             <header className='md:hidden px-4 py-6 flex justify-between items-center z-50 fixed w-full bg-[#85858526] backdrop-blur-[12px] shadow-lg'>
//                 <Logo />
//                 <button onClick={() => setOpenMenu(!openMenu)}>
//                     <Image src="/svg/menu-burger.svg" alt='' width={20} height={20} />
//                 </button>
//             </header>
//             <nav className={`fixed left-0 top-0 w-full h-full bg-gradient-to-r from-blue-50 to-blue-50 z-40 transition-transform duration-300 ease-in-out
...
//                     </div>
//                 </div>
//                 <ul className='flex flex-col items-start px-4 mt-6 gap-6'>
//                     {
...
//                                             href={item.href}
//                                             onClick={() => setOpenMenu(false)}
//                                             className={`block w-full px-4 py-2 text-lg font-medium rounded-md text-white hover:bg-blue-700 ${isActive ? 'bg-blue-700' : ''}`}
//                                         >
//                                             {item.label}
//                                         </Link>
//                                         {
        ...
        <>
            <header
                className={`md:hidden px-4 py-6 flex justify-between items-center z-50 fixed w-full transition-all duration-300 ${
                    isScrolled ? 'bg-[#05095080] backdrop-blur-md' : 'bg-[#85858526] backdrop-blur-[12px]'
                } shadow-lg`}
            >
                <Logo />
                <button onClick={() => setOpenMenu(!openMenu)}>
