...
const GutenbergRenderer = ({ content }) => {
...
const BlockRenderer = ({ block }) => {
    ...
    switch (blockName) {
        case 'core/paragraph':
            return (
                <p className={styles.wpBlockParagraph}>
        ...
        case 'core/heading':
            ...
            return React.createElement(
                HeadingTag,
                {
                    className: `${styles.wpBlockHeading} has-text-align-${attrs?.textAlign || 'left'}`
                },
                parse(sanitizedInnerHTML)
            );
        ...
        case '':
            ...
            return sanitizedInnerHTML ? (
                <div className="wp-block-freeform">
                    {parse(sanitizedInnerHTML)}
                </div>
            ) : null;
